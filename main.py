...
def send():
    if textReceipt.get(1.0, END) == '\n':
        ...
        def send_msg():
            ...
            auth = 'DhZyLvISRT0r2BNtGuFj5XY6VksceiOJzmgfQWlod9CKHbMUnqNxaYLubc1jdQ7mFSX53AyeKp6kOqfW'
        ...
        root2.iconbitmap('bill.ico')

        logoImage = PhotoImage(file='sender.png')
        label = Label(root2, image=logoImage, bg='black')
        label.pack(pady=5)

        numberLabel = Label(root2, text='Mobile Number', font=('arial', 18, 'bold underline'), bg='black', fg='gold')
        numberLabel.pack(pady=5)

        numberfield = Entry(root2, font=('helvetica', 22, 'bold'), bd=3, width=24)
        numberfield.pack(pady=5)

        billLabel = Label(root2, text='Bill Details', font=('arial', 18, 'bold underline'), bg='black', fg='gold')
        ...
        sendButton = Button(root2, text='SEND', font=('arial', 19, 'bold'), bg='gold', fg='black', bd=0, relief=GROOVE
                            , command=send_msg)
...
costFrame = Frame(menuFrame, bd=4, relief=RIDGE, bg='gray9', pady=10)
...
labelCostofFood = Label(costFrame, text='Cost of Food', font=('arial', 16, 'bold'), bg='gray9', fg='white')
...
labelCostofDrinks = Label(costFrame, text='Cost of Drinks', font=('arial', 16, 'bold'), bg='gray9', fg='white')
...
labelCostofCakes = Label(costFrame, text='Cost of Cakes', font=('arial', 16, 'bold'), bg='gray9', fg='white')
...
labelSubTotal = Label(costFrame, text='Sub Total', font=('arial', 16, 'bold'), bg='gray9', fg='white')
labelSubTotal.grid(row=0, column=2)

textSubTotal = Entry(costFrame, font=('arial', 16, 'bold'), bd=6, width=14, state='readonly', textvariable=subtotalvar)
textSubTotal.grid(row=0, column=3, padx=41)

labelServiceTax = Label(costFrame, text='Service Tax', font=('arial', 16, 'bold'), bg='gray9', fg='white')
...
labelTotalCost = Label(costFrame, text='Total Cost', font=('arial', 16, 'bold'), bg='gray9', fg='white')
...
buttonSend = Button(buttonFrame, text='Send', font=('arial', 14, 'bold'), fg='white', bg='black', bd=3, padx=5,
                    command=send)
...
button7 = Button(calculatorFrame, text='7', font=('arial', 16, 'bold'), fg='gold', bg='black', bd=6, width=6,
                 command=lambda: buttonClick('7'))
button7.grid(row=1, column=0)

button8 = Button(calculatorFrame, text='8', font=('arial', 16, 'bold'), fg='gold', bg='black', bd=6, width=6,
                 command=lambda: buttonClick('8'))
button8.grid(row=1, column=1)

button9 = Button(calculatorFrame, text='9', font=('arial', 16, 'bold'), fg='gold', bg='black', bd=6, width=6
                 , command=lambda: buttonClick('9'))
button9.grid(row=1, column=2)

buttonPlus = Button(calculatorFrame, text='+', font=('arial', 16, 'bold'), fg='gold', bg='black', bd=6, width=6
                    , command=lambda: buttonClick('+'))
buttonPlus.grid(row=1, column=3)

button4 = Button(calculatorFrame, text='4', font=('arial', 16, 'bold'), fg='gold', bg='black', bd=6, width=6
...
buttonMinus = Button(calculatorFrame, text='-', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6
                     , command=lambda: buttonClick('-'))
...
buttonAns = Button(calculatorFrame, text='Ans', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6,
                   command=answer)
buttonAns.grid(row=4, column=0)

buttonClear = Button(calculatorFrame, text='Clear', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6
                     , command=clear)
